...
namespace Account.PostgresMigrations.Migrations
{
    ...
    [Migration("20240904073140_CreateRolePermission")]
    partial class CreateRolePermission
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Account.Domain.Models.RolePermission", b =>
                {
                    b.Property<string>("RoleId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Account.Domain.Models.Permission", b =>
                {
                    b.HasOne("Account.Domain.Models.Role", null)
            ...
            modelBuilder.Entity("Account.Domain.Models.RolePermission", b =>
                {
                    b.HasOne("Account.Domain.Models.Permission", "Permission")
            ...
            modelBuilder.Entity("Account.Domain.Models.UserRole", b =>
                {
                    ...
                    b.HasOne("Account.Domain.Models.User", "User")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Account.Domain.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
